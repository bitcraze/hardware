...
The Crazyflie<sup>TM</sup> AI-deck monochrome camera module is a monochrome camera module, HM01B0-MNA, with a 320 x 320 resolution targeting computer vision applications from Himax. For full datasheet please contact Himax Technologies Inc.
{% enddatasheet_intro %}
